...
const styles = StyleSheet.create({
  ...
  voltageText: { fontFamily: fontFamily.semibold, fontSize: 12, color: theme.accent },
  scroll: { paddingHorizontal: 16 },
  sectionLabel: { fontFamily: fontFamily.semibold, fontSize: 9, letterSpacing: 2, color: theme.textSecondary, textTransform: 'uppercase', marginTop: 16, marginBottom: 8 },
  input: { fontFamily: fontFamily.regular, backgroundColor: theme.bgCard, borderWidth: 0.5, borderColor: theme.border, borderRadius: 10, padding: 12, color: theme.textPrimary, fontSize: 14, marginBottom: 8 },
  ...
  typeLeft: { flex: 1 },
  typeLabel: { fontFamily: fontFamily.semibold, fontSize: 14, color: theme.textPrimary },
  typeLabelActive: { color: theme.accent },
  typeDesc: { fontFamily: fontFamily.light, fontSize: 11, color: theme.textSecondary, marginTop: 2 },
  ...
  capacityBtnActive: { borderColor: theme.primary, backgroundColor: colors.blue10 },
  capacityTxt: { fontFamily: fontFamily.monoRegular, fontSize: 13, color: theme.textSecondary },
  capacityTxtActive: { fontFamily: fontFamily.monoBold, color: theme.accent },
  orTxt: { fontFamily: fontFamily.light, fontSize: 11, color: theme.textSecondary, textAlign: 'center', marginBottom: 8 },
  previewCard: { backgroundColor: colors.bgInset, borderWidth: 0.5, borderColor: 'rgba(27,79,155,0.20)', borderRadius: 12, padding: 14, alignItems: 'center', marginTop: 8, marginBottom: 8 },
  previewLabel: { fontFamily: fontFamily.semibold, fontSize: 10, color: theme.textSecondary, letterSpacing: 1, textTransform: 'uppercase' },
  previewPct: { fontFamily: fontFamily.display, fontSize: 52, color: theme.accent, marginVertical: 4 },
  previewSub: { fontFamily: fontFamily.light, fontSize: 11, color: theme.textSecondary },
  ...
  cancelTxt: { fontFamily: fontFamily.regular, fontSize: 14, color: theme.textSecondary },
  saveBtn: { flex: 2, backgroundColor: colors.blue, borderWidth: 0.5, borderColor: theme.primary, borderRadius: 12, padding: 14, alignItems: 'center' },
  saveTxt: { fontFamily: fontFamily.semibold, fontSize: 14, color: colors.textInverse },
});