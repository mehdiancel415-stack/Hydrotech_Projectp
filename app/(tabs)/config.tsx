...
const s = StyleSheet.create({
  ...
  sectionIconWrap: {
    ...
    backgroundColor: colors.blue10, borderWidth: 1, borderColor: colors.borderBlue,
  ...
  rowRight: {},
  rowArrow: { fontFamily: fontFamily.regular, fontSize: 22, color: colors.blue },
  ...
  chipActive: { borderColor: colors.blue, backgroundColor: colors.blue10 },
  chipTxt: { fontFamily: fontFamily.monoMedium, fontSize: 13, color: colors.textSecondary },
  chipTxtActive: { color: colors.blue, fontFamily: fontFamily.semibold },
  ...
  priorityNumTxt: { fontFamily: fontFamily.bold, fontSize: 13, color: colors.textInverse },
  ...
  arrowTxt: { fontFamily: fontFamily.bold, fontSize: 14, color: colors.blue },
